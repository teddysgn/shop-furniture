<?php
    ...
    // PAGINATION
    $paginationHTML = $this->pagination->showPaginator(URL::createLink('admin', 'category', 'index'));
                                ...
                                <table class="table align-items-center table-flush table-borderless">
                                    ...
                                    if(!empty($this->Items)) {
                                        ...
                                        foreach ($this->Items as $key => $value) {
                                            ...
                                            $status		= Helper::cmsOther($value['status'], URL::createLink('admin', 'category', 'ajaxStatus', array('id' => $id, 'status' => $value['status'])), $id);
                                            ...
                                            echo '<tbody>
                                                    <tr class="'.$row.'">
                                                        ...
                                                        <td width="10%" class="order">'.$ordering.'</td>
