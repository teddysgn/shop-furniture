...
$inputOrdering      = Helper::cmsInput('number', 'form[ordering]', 'ordering', $this->arrayParam['form']['ordering'], 'inputbox form-control', '40');
$inputValue         = Helper::cmsInput('number', 'form[value]', 'value', $this->arrayParam['form']['value'], 'inputbox form-control', '40');
$inputCode          = Helper::cmsInput('text', 'form[code]', 'code', $this->arrayParam['form']['code'], 'inputbox form-control', '40');
$inputQuantity      = Helper::cmsInput('number', 'form[quantity]', 'quantity', $this->arrayParam['form']['quantity'], 'inputbox form-control', '40');
$inputUsed          = Helper::cmsInput('number', 'form[used]', 'used', $this->arrayParam['form']['used'], 'inputbox form-control', '40');
...
$rowCode            = Helper::cmsRowForm('Code', $inputCode);
$rowStatus          = Helper::cmsRowForm('Status', $selectStatus);
$rowQuantity        = Helper::cmsRowForm('Quantity', $inputQuantity);
$rowUsed            = Helper::cmsRowForm('Used', $inputUsed);
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" method="post" name="adminForm" id="adminForm">
                            <?php echo $rowID .  $rowCode . $rowName . $rowValue . $rowOrdering . $rowQuantity . $rowUsed . $rowStatus; ?>
                                <div>
                                    <?php echo $inputToken; ?>
                                </div>
