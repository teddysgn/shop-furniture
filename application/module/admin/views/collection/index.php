                                ...
                                <table class="table align-items-center table-flush table-borderless">
                                    ...
                                    if(!empty($this->Items)) {
                                        ...
                                        foreach ($this->Items as $key => $value) {
                                            ...
                                            $status		= Helper::cmsOther($value['status'], URL::createLink('admin', 'collection', 'ajaxStatus', array('id' => $id, 'status' => $value['status'])), $id);
                                            ...
                                            $linkEdit   = URL::createLink('admin', 'collection', 'form',array('id' => $id));
