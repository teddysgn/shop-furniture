<?php
$paginationHTML = $this->pagination->showPaginator(URL::createLink('designer', 'index', 'category', array('category_id' => $_GET['category_id'])));
?>
    ...
    <div class="page-container show_breadcrumb_v1 has-1-sidebar">
        ...
        <div id="left-sidebar" class="ts-sidebar">
            <aside>
                        ...
                        <ul class="product-categories">
                            ...
                            $xhtmlCollection = '';
                                foreach($this->collection as $key => $value){
                                    $class = '';
                                    $linkCollection = URL::createLink('designer', 'index', 'category', array('category_id' => $_GET['category_id'], 'collection_id' => $value['id']));
                ...
                <section id="woocommerce_layered_nav-24" class="widget-container ts-product-categories-widget">
                    <div class="widget-title-wrapper"><a class="block-control" href="javascript:void(0)"></a>
                    ...
                    <div class="ts-product-categories-widget-wrapper">
                        <ul class="product-categories">
                            ...
                            foreach($this->category as $key => $value){
                                $class = '';
                                $linkCategory = URL::createLink('designer', 'index', 'category', array('category_id' => $value['id']));
