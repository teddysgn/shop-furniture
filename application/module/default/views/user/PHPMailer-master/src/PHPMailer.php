...
class PHPMailer
{
    ...
    /**
     * Output debugging info via a group-defined method.
     ...
     *
     * ```php
     * PHPMailer::validateAddress('group@example.com', function($address) {
     ...
     * Used to reject URLs and phar file from functions that access local file paths,
     ...
     *                          Do not set this from group input!
     *
        ...
        if ('en' !== $langcode) {
            ...
            if ($foundFile === false) {
                ...
                foreach ($lines as $line) {
                    ...
                    //These file are parsed as text and not PHP so as to avoid the possibility of code injection
     ...
     * Never use a group-supplied path to a file!
     ...
     * Do not source $message content from group input!
     ...
     *                                *Never* pass group-supplied data into this parameter
     *
     * @return string
     */
    ...
    /**
     * Set the public and private key file and password for S/MIME signing.
     *
