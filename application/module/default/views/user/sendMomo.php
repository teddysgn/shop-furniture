<div class="feat_prod_box_details">
    ...
    $block = 'Bạn chưa có đơn hàng nào!';
    if(!empty($this->Items)){
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <strong class="text-black">' . number_format($totalPrice + $priceDiscount) . '</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
Session::delete('info');
Session::delete('memberDiscount');
URL::redirect('default', 'index', 'notice', array('type' => 'buy-success'));
?>
